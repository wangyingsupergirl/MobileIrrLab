...
Class Report13B extends Report {
    ...
    public function setResult() {
        ...
        if ($this->eval_method == 'both') {
            $sql1 = "create or replace view initial_eval_13b as
        ...
        $sql2 = "select distinct(initial_eval_13b.irr_sys_type) from initial_eval_13b, irr_sys_types 
		 	where initial_eval_13b.irr_sys_type = irr_sys_types.id 
		  	order by irr_sys_types.common_name";
        // }
// 		else{
// 			$sql2 = "select distinct(initial_eval_13b.irr_sys_type) from initial_eval_13b, irr_sys_types 
// 		 	where initial_eval_13b.irr_sys_type = irr_sys_types.id and initial_eval_13b.eval_method = '"."{$method}"."'
// 		  	order by irr_sys_types.common_name";
// 		}
        ...
        foreach ($groupByCrop as $key => $array) {
            ...
            $sql3 = "CREATE OR REPLACE VIEW initial_eval_13b_by_irr AS
                    SELECT * FROM initial_eval_13b
        ...
        $drop_view_sql = "drop view if exists initial_eval_13b,initial_eval_13b_by_irr";
...
<tr>
  ...
  <th width="9%">Initial Evaluation Latest Date</th>
    ...
    public function getReportTitle() {
        ...
        $this->reportTitle = " <h2 style='text-align:left;font-family:helvetica, arial, sans-serif;margin: 25px 10px 0 10px; padding-bottom: 0;'>Report 13B: <br />
            Ag MIL Program Potential Water Savings - by Irrigation System Type at Initial Evaluation and County<br />
    ...
    public function getTableContent() {
        ...
        foreach ($this->results as $irri => $content) {
            ...
            $total = array("num_of_irr_sys" => 0,
                ...
                "start_date" => 'N/A',
                "end_date" => 'N/A');
            $this->tableContent .= "Irrigation System Type: {$name}<br/><br/>";
        ...
        $this->tableContent .=
                "
		IMPORTANT NOTES:<br />
		Total PWS: Potential Water Savings, only for irrigation systems that have initial evaluations, and have no follow up evaluations.<br />
		<br /><br />
