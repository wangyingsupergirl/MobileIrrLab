 ...
 <tr>
 <td>* First Name:</td>
 <td><input name="first_name"  value="<?php echo ($member?$member->getProperty('first_name'):"")?>" type="text" class="required" size="32" maxlength="32" /></td>
 </tr>
				  
 <tr>
 <td>* Last Name:</td>
 <td><input name="last_name"  value="<?php echo ($member?$member->getProperty('last_name'):"")?>" type="text" class="required" size="32" maxlength="32" /></td>
 </tr>
				  
 <tr>
 <td>* Title:</td>
 <td><input name="title"  value="<?php echo ($member?$member->getProperty('title'):"")?>"type="text"  class="required"size="32" maxlength="32" /></td>
 </tr>
			      
 <tr>
 <td>* Phone:</td>
 <td><input name="phone" type="text" class="required" value="<?php echo ($member?$member->getProperty('phone'):"")?>" size="32" maxlength="32" /></td>
 </tr>
